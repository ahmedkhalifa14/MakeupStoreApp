...
import com.example.makeupstore.adapters.OnBoardingViewPagerAdapter
import com.example.makeupstore.animations.ZoomOutPageTransformer
import com.example.makeupstore.databinding.FragmentOnboardingBinding
            ...
            override fun onPageSelected(position: Int) {
                ...
                if (position == MAX_STEP - 1) {
                    ...
                    binding!!.btnNext.setOnClickListener {
                        mainViewModel.setFirstTimeLaunch(true)
